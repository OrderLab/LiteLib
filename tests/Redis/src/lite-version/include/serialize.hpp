...
std::shared_ptr<std::map<std::string, std::string>> stringToMap(const std::string &str)
{
...
std::string listToString(const std::shared_ptr<std::list<std::string>> &listPtr)
{
    std::ostringstream oss;
...
std::shared_ptr<std::set<std::pair<std::string,int>>> stringToZSet(const std::string &str)
{
...
std::string zSetToString(const std::shared_ptr<std::set<std::pair<std::string,int>>> &zsetPtr)
{
    std::ostringstream oss;
