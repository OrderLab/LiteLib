...
LevelDBServer *main_server_ptr = nullptr;

LevelDBServer::LevelDBServer(const size_t &nthreads,
...
bool LevelDBServer::Run(const char *port) {
  int sfd;
...
void LevelDBServer::EventHandler(const evutil_socket_t fd, const short which,
                                   void *arg_conn) {
